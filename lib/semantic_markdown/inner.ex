defmodule SemanticMarkdown.Inner do
  ...
  @spec clean_content(Type.content | {atom(), Type.content}) :: Type.content | {atom(), Type.content}
  ...
  @spec transform_node({String.t | atom(), Type.ast_tuple}, Type.options_map) :: {atom(), String.t | Type.content}
  ...
  @spec transform({atom() | String.t, Type.ast_tuple}, Type.options_map) :: {atom(), Type.content()}
